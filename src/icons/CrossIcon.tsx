...
function getSmallStroke(): JSX.Element {
  return (
    <>
      <path d={strokeSmallPath} fill={theme.colors.text.black} />
    </>
  )
}
...
function getSmallFilled(): JSX.Element {
  return (
    <>
      <path d={filledSmallPath} fill={theme.colors.text.black} />
    </>
  )
}
