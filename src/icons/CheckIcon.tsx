...
function getBigFilled(): JSX.Element {
  return (
    <>
      <path d={filledBigPath} fill={theme.colors.text.black} />
    </>
  )
}
...
function getBigStoke(): JSX.Element {
  return (
    <>
      <path d={strokeBigPath} fill={theme.colors.text.black} />
    </>
  )
}
