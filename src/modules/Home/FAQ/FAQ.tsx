...
const questions = [
  {
    ...
    answer: (
      <>
        ...
        <br />
        <br />
        Достаточно перейти по кнопке{' '}
        <Link href="/lead/add">«Создать заявку»</Link> и ответить на несколько
        простых вопросов о недвижимости, которую вы ищите. Это займёт примерно
        две минуты времени. <br />
  ...
  },
  {
    ...
    answer: (
      <>
        Вы можете опубликовать заявку бесплатно. Или выбрать платные опции для
        увеличения просмотров и откликов. К платным опциям относятся: <br />
        <br />
        ...
        Важно! <br />
        <br />
        1. Публикация 2-х и более заявок в рамках 30 дней возможна только при
        включённой опции «Открыть отклик для всех». <br />
        <br /> 2. Любая выбранная опция даёт вашей заявке отметку TRUE и
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <br /> <br /> 1. Пройти регистрацию и ответить на простые вопросы о
        недвижимости, которую вы предлагаете. <br /> <br /> 2. Перейти в ленту
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        зарегистрированный пользователь. <br /> <br /> Достаточно перейти по
        кнопке <a href="">«Загрузить объект»</a> и ответить на несколько
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        недвижимости. <br /> <br /> Если предложение заинтересует заказчика, он
        сам инициирует обмен контактами для дальнейшего общения.
      </>
    ),
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        недвижимости необходимо <Link href="/lead/add">создать заявку</Link>.
        После чего, продавцы начнут предлагать вам объекты в ручном режиме.
        Таким образом для вас будет сформирован персональный каталог
        недвижимости в режиме реального времени.
      </>
    ),
    id: 7,
  },
      ...
      <div className="Container FAQ">
        <div className="FAQ__titleContainer">
          ...
          <p className="FAQ__description Font_18_150 sm:Font_16_24">
            ...
            <a target={'_blank'} href="https://faq.miraden.com/">
              базу знаний
            </a>{' '}
            или напишите в{' '}
            <a target={'_blank'} href="https://t.me/miraden_support">
              поддержку
            </a>
          </p>
          <Image
