...
const questions = [
  {
    ...
    answer: (
      <>
        ...
        <br />
        <br />
        Достаточно перейти по кнопке «Создать заявку» и ответить на несколько
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        по кнопке «Загрузить объект» и ответить на несколько вопросов
        о недвижимости, которую хотите добавить. После чего страница объекта
        будет опубликована в разделе «Мои объекты». <br /> <br /> Важно! <br />
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        недвижимости необходимо создать заявку. После чего, продавцы начнут
        предлагать вам объекты в ручном режиме. Таким образом для вас будет
        сформирован персональный каталог недвижимости в режиме реального
        времени.
      </>
    ),
    id: 7,
      ...
      <div className="Container FAQ">
        <div className="FAQ__titleContainer">
          ...
          <p className="FAQ__description Font_18_150 sm:Font_16_24">
            ...
            <a>базу знаний</a>  или напишите в <a>поддержку</a>
          </p>
          <Image
            src="/images/FAQ.svg"
            alt=""
