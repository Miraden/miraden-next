...
const questions = [
  {
    ...
    answer: (
      <>
        ...
        <br />
        <br />
        Достаточно перейти по кнопке <Link href="/lead/add">«Создать заявку»</Link> и ответить
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        недвижимости необходимо <Link href="/lead/add">создать заявку</Link>. После чего,
      ...
      <div className="Container FAQ">
        <div className="FAQ__titleContainer">
          ...
          <p className="FAQ__description Font_18_150 sm:Font_16_24">
            ...
            <a target={"_blank"} href="https://faq.miraden.com/">базу знаний</a> или напишите в <a target={"_blank"} href="https://t.me/miraden_support">поддержку</a>
          </p>
          <Image
