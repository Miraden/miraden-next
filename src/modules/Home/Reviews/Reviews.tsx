...
const reviews = [
  {
    ...
    text: '<p>Изначально думала что это портал зарубежной недвижимости, но оказалось что это что-то новое ).</p><p>Оставила заявки на подбор объектов неделю назад, но до сих пор мне каждый день поступают новые интересные предложения от продавцов.</p>',
  ...
  },
  {
    ...
    text: '<p>Я очень доволен, что на этом сайте познакомился с риэлтором Daniil Velnekov. Он оказал полное сопровождение в поиске и аренде 3-х комнатной виллы на Бали.</p><p>Если ищите недвижимость за границей, значит вы по адресу!</p>',
  ...
  },
  {
    ...
    text: '<p>Узнала о сайте от знакомых. У меня остались хорошие впечатления после использования этого сервиса. Получила больше 30 вариантов недвижимости от разных агентов и собственников. На каждой странице недвижимости есть подробная информация, фото, видео и удобный чат с продавцами.</p>',
  ...
  },
  {
    ...
    text: '<p>Хороший портал по поиску агентов, застройщиков и самой недвижимости.</p><p>Хочу отметить то, что объекты продавцов можно удобно отфильтровать, чтобы найти подходящий вариант... Также я была довольна работой агентства, которое нашла на сайте. Спасибо Lihoms!!!</p>',
  ...
  },
  {
    ...
    text: '<p>Искал апартаменты на С. Кипре для инвестиций. Miraden оказался тем сайтом, где я получил больше всего предложений и быстро нашел то, что надо!</p><p>Еще хочу отметить работу поддержки. Возникли вопросы по оплате брони, но мне быстро ответили и помогли.</p>',
  ...
  },
  {
    ...
    text: '<p>Понравилось то, что можно оставить заявку с подробным описанием один раз и больше не тратить время на одинаковые разговоры. Причем размещение заявки бесплатно, но я заказал дополнительную рекламу и это дало свой результат!</p>',
