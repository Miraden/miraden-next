    ...
    <>
      ...
      <div className={'Buttons__wrap'}>
        ...
        <div className={'Buttons__group'}>
          ...
          <Button compact disabled rightIcon={<StarIcon />}>
            Button
          </Button>
          <Button compact disabled leftIcon={<StarIcon />}>
            Button
          </Button>
        </div>
      </div>
    ...
    <>
      ...
      <div className={'Buttons__wrap'}>
        <div className={'Buttons__group'}>
          ...
          <Button secondary rightIcon={<StarIcon />}>
            Right icon
          </Button>
          <Button secondary leftIcon={<StarIcon />}>
            Left Icon
          </Button>
          <Button secondary disabled>
            Button
          </Button>
          <Button secondary disabled rightIcon={<StarIcon />}>
            Right icon
          </Button>
          <Button secondary disabled leftIcon={<StarIcon />}>
            Left Icon
          </Button>
        </div>
        ...
        <div className={'Buttons__group'}>
          ...
          <Button secondary compact disabled>
            Button
          </Button>
          <Button secondary compact disabled rightIcon={<StarIcon />}>
            Right icon
          </Button>
          <Button secondary compact disabled leftIcon={<StarIcon />}>
            Left Icon
          </Button>
        </div>
      </div>
    ...
    <>
      ...
      <div className={'Buttons__wrap'}>
        <div className={'Buttons__group'}>
          ...
          <Button tertiary disabled rightIcon={<StarIcon />}>
            Right icon
          </Button>
          <Button tertiary disabled leftIcon={<StarIcon />}>
            Left Icon
          </Button>
        </div>
        ...
        <div className={'Buttons__group'}>
          ...
          <Button tertiary compact rightIcon={<StarIcon />}>
            Right icon
          </Button>
          <Button tertiary compact leftIcon={<StarIcon />}>
            Left Icon
          </Button>
          <Button tertiary compact disabled>
            Button
          </Button>
          <Button tertiary compact disabled rightIcon={<StarIcon />}>
            Right icon
          </Button>
          <Button tertiary compact disabled leftIcon={<StarIcon />}>
            Left Icon
          </Button>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <div className="HeaderButtons Buttons__group">
        ...
        <Button header disabled leftIcon={<StarIcon />}>
          Header
        </Button>
        <Button header rightIcon={<StarIcon />}>
          Header
        </Button>
        <Button header active rightIcon={<StarIcon />}>
          Active
        </Button>
        <Button header disabled rightIcon={<StarIcon />}>
          Header
        </Button>
    ...
    <>
      ...
      <div className={'Buttons__wrap'}>
        ...
        <div className={'Buttons__group'}>
          ...
          <Button request disabled compact>
            Disabled
          </Button>
          <Button request compact active>
            Active
          </Button>
        </div>
      </div>
...
function renderIconify(): JSX.Element {
  return (
    <>
      ...
      <div className={'Buttons__wrap'}>
        <div className={'Buttons__group'}>
          <div className="Buttons__GroupTitle Font_Accent_20_B">
            {'Primary'}
          </div>
...
function renderSort(): JSX.Element {
  return (
    <>
      ...
      <div className={'Buttons__wrap'}>
        <div className={'Buttons__group'}>
          <Button sort rightIcon={<ArrowsIcon bottom />}>
            Sort
          </Button>
        </div>
      </div>
